...
CPU.InstructionSet={
	...
	// misc instructions;
	    ...
	    "syscall":{size:1,code:1,impl:function(cpu){ 
		     cpu._syscall(); 
		}},
...
CPU.prototype={
	...
	_syscall:function(){
	    var calltype=this._readUInt32(this._regMem[this._regs['$sp']]);
		var baddr = this._readUInt32(this._regMem[this._regs['$sp']]+4);
		  //  baddr = (baddr | this._mem[this._regMem[this._regs['$sp']]+2]<<8)>>>0;
		//	baddr = (baddr |this._mem[this._regMem[this._regs['$sp']]+3]<<16)>>>0;
		//	baddr = (baddr |this._mem[this._regMem[this._regs['$sp']]+4]<<24)>>>0;
		//	console.log(baddr);
		var numBytes = this._readUInt32(this._regMem[this._regs['$sp']]+8);
		switch(calltype){
		   case 0:
