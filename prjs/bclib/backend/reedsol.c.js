...
#include "reedsol.h"
/*int*/var gfpoly;
/*int*/var symsize;		// in bits
/*int*/var logmod;		// 2**symsize - 1
/*int*/var rlen;
...
/*void*/function rs_init_gf(/*int*/ poly)
{
	/*int*/ var m, b, p, v;
...
/*void*/function rs_init_code(/*int*/ nsym, /*int*/ index)
{
	/*int*/var i, k;
...
/*void*/function rs_encode(/*int*/ len, /*unsigned char **/data, /*unsigned char **/res)
{
	/*int*/var i, k, m;
	for (i = 0; i < rlen; i++)
		res[i] = 0;
...
/*void*/ function rs_encode_long(/*int*/ len, /*unsigned int **/data, /*unsigned int **/res)
